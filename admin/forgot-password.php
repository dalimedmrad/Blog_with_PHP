                                    ...
                                    <div class="card-body">
                                        ...
                                        if(isset($_POST['update'])){
                                            ...
                                            if( $password == $confirm_password){
                                                ...
                                                echo"<p class='alert alert-danger'>Pssword doesn't match </p>";
                                            }
                                        }
                                        ...
                                        <?php  if(!isset($show)) { ?>
                                            <form action="forgot-password.php" method="POST">
                                                <div class="form-group">
                                                    ...
                                                    <input name="nickname" class="form-control py-4" id="Nickname" type="text" placeholder="Enter your Nickname" />
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="password" class="form-control py-4" id="password" type="password" placeholder="Enter your password" required="true" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="confirmpassword">Confirm Password</label>
                                                <input name="confirm-password" class="form-control py-4" id="confirmpassword" type="password" required="true" placeholder="Enter your confirm password" />
                                            </div>
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
