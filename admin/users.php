                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="./assets/img/<?php echo $user_photo; ?>" width="50" height="50"></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php 
                                                            if($user_id  == $u_id){?>
                                                                <button title="You can't delate your self" class="btn btn-red btn-icon"><i data-feather="trash-2"></i></button>
                                                            <?php } else { ?>
