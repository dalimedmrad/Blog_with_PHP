<?php 
    ...
    <?php } else {
        if(!isset($_COOKIE['_uid_']) && !isset($_COOKIE['_uiid_'])) {
            echo '<a class="btn-teal btn rounded-pill px-4 ml-lg-4" href="admin/signin.php">Sign in</a>';
            echo '<a class="btn-teal btn rounded-pill px-4 ml-lg-4" href="admin/signup.php">Sign up</a>';
        } else {
