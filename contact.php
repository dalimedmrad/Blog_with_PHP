                            ...
                            <?php 
                                if(isset($_COOKIE['_uid_']) || isset($_COOKIE['_uiid_']) || isset($_SESSION['login'])){?>
                                    <form action="contact.php" method="POST">
                                        ...
                                        <div class="text-center"><button name="send" class="btn btn-primary btn-marketing mt-4" type="submit">Submit Request</button></div>
                                    </form>
                             <?php } else { ?>
                                    <a href="./admin/signin.php"> Sign in to contact us ! </a>
                             <?php } ?>
